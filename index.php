...
if (isset($options['h']) || isset($options['help'])) {
    echo "Данная программа преобразовывает файлы формата .csv*
...
-s|--strict      проверять, что исходный файл содержит необходимое количество
                 описанных в конфигурационном файле  столбцов. 
                 При несоответствии выдавать ошибку.
...
if (isset($options['s']) || isset($options['strict'])) {
    ...
    if ($stNum == 4) {
        ...
        echo "Ошибка несоответствия столбцов во 
        входном и конфигурационном файлах. \n";
        exit();
    }
}
